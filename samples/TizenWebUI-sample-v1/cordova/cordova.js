...
module.exports = {
    ...
    confirm: function(message, confirmCallback, title, buttonLabels) {
        ...
        buttonLabelsType = typeof(buttonLabels);
        console.log ("buttonLabelsType: ", buttonLabelsType );

        switch(buttonLabelsType)
        {
        case "string":
            ...
            for (index in buttonsArray) {
                buttonString += '<li><button id="popup-button-' + buttonsArray[index]+
        ...
        case "object":
        	if (utils.isArray(buttonsArray)) {
                console.log ("cordova/plugin/tizen/Notification, default, buttonLabels is not an array or a string: ", buttonLabels);
                break;
        	}
        	//else we can continue as it is an Array
    ...
    prompt: function(message, promptCallback, title, buttonLabels) {
        ...
        titleString = '<div class="popup-title"><p>' + title + '</p></div>';
        messageString = '<div class="popup-text"><p>' + message + '</p></div>';
        inputString =  '<div class="popup-input-text-bg"><input id="popup-input-text"/></div>';
        buttonString = '<div class="popup-button-bg"><ul>';
        ...
        popup.style.position = "fixed";
        popup.style.zIndex = 1002;
        popup.innerHTML = titleString + messageString + inputString + buttonString;
        ...
        function createListener(button) {
            return function() {
                ...
                inputText = document.getElementById("popup-input-text").value;
            };
        }
